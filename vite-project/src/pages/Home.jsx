...
<div class="flex flex-col items-center w-50%   rounded-lg shadow md:flex-row       w-30% p-4">
    <div class="flex flex-col  leading-normal w-50%">
    <h2 className='text-white text-xl mt-12 ml-12'>WHY KOUNT</h2>
...
We use data-driven decisions, advanced machine learning, and decades of experience to overcome the challenges that commonly plague today's growing businesses. The result is greater confidence in every interaction.</p>
 ...
 <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
      <h2 className='text-blue-600 font-bold mb-2 mt-24'>OUR SECRET SAUCE</h2>
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white "> What makes Kount different</h2>
          <p class="mb-5 font-bold text-white sm:text-xl "> There are three things that define Kount. And we believe Kount is the only company that has this unique combination of strengths.</p>
      </div>
      <div className='flex'>
      <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900  rounded-lg   l:p-8 ml-8">
              <h3 class="mb-4 text-2xl font-bold text-white">Complete Strategy</h3>
              <p class="font-bold text-white sm:text-lg ">You need protection against any threat that could come your way. And we have everything you could possibly need — all in one easy-to-use platform.</p>
              ...
              <ul role="list" class="mb-8 space-y-4 text-left mt-12">
                  <li class="flex items-center space-x-3">
                      ...
                      <span className='text-white'>Pick the solutions that are relevant to your business</span>
                  </li>
                  <li class="flex items-center space-x-3">
      
                      <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                      <span  className='text-white'>Adjust processes as your business grows and needs change</span>
                  </li>
                  <li class="flex items-center space-x-3">
               
                      <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                      <span><span class="font-semibold text-white">Simplify budgeting with just one expense</span></span>
                  </li>
                  <li class="flex items-center space-x-3">
            
                      <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                      <span> <span class="font-semibold text-white">Monitor outcomes with greater accuracy and transparency</span></span>
                  </li>
                  <li class="flex items-center space-x-3">
          
                      <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                      <span> <span class="font-semibold text-white">Reduce operational costs and boost your bottom line</span></span>
                  </li>
              </ul>
      ...
      <div class="flex flex-col p-6  text-center text-white  rounded-lg   l:p-8 ml-16">
              <h3 class="mb-4 text-2xl font-bold ml-48 text-white">Complete Strategy</h3>
      ...
      <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-white  rounded-lg   l:p-8 ml-8">
              <h3 class="mb-4 text-2xl font-bold">Complete Strategy</h3>
              <p class="font-semibold text-white sm:text-lg ">You need protection against any threat that could come your way. And we have everything you could possibly need — all in one easy-to-use platform.</p>
...
<section class=" mt-12">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      ...
      <h2 className='text-green-600 font-bold mb-2'>THE PROBLEM</h2>
          <h2 class="mb-4 text-4xl  font-extrabold text-white">Designed for business teams like yours</h2>
          <p class="mb-5 font-bold text-white sm:text-xl ">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
      <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
      {cards.map((item)=>{
 ...
 <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12 mt-36">
      ...
      <div className='flex mt-24 pl-12 mb-8 '>
      <div class="flex flex-col  leading-normal w-9/12">
    <h2 className='text-xl mt-12 ml-8 text-blue-600'>pricing</h2>
        <h5 class=" text-5xl ml-4 font-bold tracking-tight text-white p-2">How much kount costs</h5>
        <p class=" font-normal text-white dark:text-gray-400 text-2xl p-4">How much does trust and safety cost? Kount offers a la carte pricing so you only pay for the services you need —  and nothing you don't. That means your cost depends on the solutions you use.</p>
...
<h5 class="font-bold text-white ml-32 text-5xl">What our clients are saying</h5>
