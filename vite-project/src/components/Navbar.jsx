...
function Navbar() {
  return (
    <>
    <nav class="text-white fixed w-full z-20 top-0 start-0  dark:border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <span class="self-center text-2xl font-semibold whitespace-nowrap text-gray-900">KOUNT</span>
    </a>
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        ...
        <li className='group relative w-full'>
            <NavLink to="/" class="block py-2 px-3 bg-blue-700 rounded md:bg-transparent md:p-0 menu-hover w-full text-gray-900"  onClick="">Why Kount
            <div className='invisible absolute flex bg-white text-gray-900 py-1 px-4 group-hover:visible ' onClick="" style={{left:-490,width:'100vw'}}>
...
{count1.map((item)=>{
    return  <div class="w-6/12 h-full bg-white m-8 ">
    <div class="p-8 m-8">
        <a href="#">
        ...
        <li className='group relative'>
            <NavLink to="/features" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500  dark:hover:bg-gray-700  md:dark:hover:bg-transparent dark:border-gray-700 " >Features
...
{count1.map((item)=>{
    ...
    <div class="p-8 m-8">
        ...
        <li className='group relative'>
            <NavLink to="/industries" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500  dark:hover:bg-gray-700  md:dark:hover:bg-transparent dark:border-gray-700 " >Industries
            {/* <div className='invisible absolute z-50 flex w-full flex-col bg-gray-900 py-1 px-4 text-white group-hover:visible' onClick="">
                <a className='my-2 block border-b border-gray-100 font-semibold text-white hover:text-gray-900'>P1 </a>
                <a className='my-2 block border-b border-gray-100 font-semibold text-white hover:text-gray-900'>P2 </a>
                <a className='my-2 block border-b border-gray-100 font-semibold text-white hover:text-gray-900'>P3 </a>
...
{count1.map((item)=>{
    ...
    <div class="p-8 m-8">
        ...
        <li className='group relative'>
            <NavLink to="/resources" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500  dark:hover:bg-gray-700  md:dark:hover:bg-transparent dark:border-gray-700 " >Resources
            {/* <div className='invisible absolute z-50 flex w-full flex-col bg-gray-900 py-1 px-4 text-white group-hover:visible' onClick="">
                <a className='my-2 block border-b border-gray-100 font-semibold text-white hover:text-gray-900'>P1 </a>
                <a className='my-2 block border-b border-gray-100 font-semibold text-white hover:text-gray-900'>P2 </a>
                <a className='my-2 block border-b border-gray-100 font-semibold text-white hover:text-gray-900'>P3 </a>
...
{count1.map((item)=>{
    ...
    <div class="p-8 m-8">
        ...
        <li className='group relative'>
            <NavLink to="/pricing" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500  dark:hover:bg-gray-700  md:dark:hover:bg-transparent " >Pricing
            ...
            <div className='invisible absolute flex bg-gray-900  py-1 px-4 group-hover:visible ' onClick="" style={{left:-900,width:'100vw'}}>
                {/* <a className='my-2 block border-b border-gray-100 font-semibold text-white hover:text-gray-900'>P1 </a>
                <a className='my-2 block border-b border-gray-100 font-semibold text-white hover:text-gray-900'>P2 </a>
                <a className='my-2 block border-b border-gray-100 font-semibold text-white hover:text-gray-900'>P3 </a> */}
